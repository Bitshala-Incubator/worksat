...
const JobDetail = () => {
  return (
    ...
    <div className="flex flex-col">
      ...
      <div>
        Job detail Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rem
        dolores, ad eum error magni laudantium tempore quia. Esse deleniti
      ...
      <div className="flex justify-center">
        ...
        <div className="bg-red-400 p-3 rounded-lg mx-3 mb-10 mt-3">Apply now</div>
    </div>
    </>
  );
};
