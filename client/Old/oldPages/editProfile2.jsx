        ...
        <div className="w-full">
          <form className="text-start p-5 border bg-white md:mx-5 rounded-xl ">
            <div>
              ...
              <input
                placeholder={devDetail.lightningAddress}
              ...
              <input
                placeholder={devDetail.linkedin}
